...
When you run the code /Train API is invoked and trains the model and save the file in a pickle format. For predictions we exposed /Predict API that takes the height and returns the predicted weight value.
